      ...
      <nav className="fixed top-0 w-full bg-white/80 backdrop-blur-md z-50 border-b">
        <div className="max-w-7xl mx-auto px-4 h-16 flex justify-between items-center">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-bold">Javari Nonprofits</span>
          </div>
          <a href="/signup" className="bg-rose-600 text-white px-4 py-2 rounded-lg hover:bg-rose-700">Get Started</a>
        </div>
      </nav>
      
      <section className="pt-32 pb-20 px-4 text-center">
        <motion.div initial={{opacity:0,y:20}} animate={{opacity:1,y:0}}>
          <span className="inline-flex items-center gap-2 bg-rose-100 text-rose-700 px-4 py-2 rounded-full text-sm mb-6">
            <Zap className="w-4 h-4" /> AI-Powered Platform
          </span>
          <h1 className="text-5xl font-bold text-slate-900 mb-6">Javari Nonprofits</h1>
          <p className="text-xl text-slate-600 mb-8 max-w-2xl mx-auto">
            Powered by Javari AI. Part of the CR AudioViz AI ecosystem.
          </p>
          <a href="https://javariai.com" className="inline-flex items-center gap-2 bg-rose-600 text-white px-8 py-4 rounded-lg font-semibold">
